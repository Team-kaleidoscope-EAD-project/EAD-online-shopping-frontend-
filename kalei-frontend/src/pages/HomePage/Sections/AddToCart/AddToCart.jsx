...
const CartPage = () => {
  ...
  return (
    <Box p={3}>
      <Typography variant="h5" align="left" color='#7C4100' mb={1}>Your Cart</Typography>
      <Divider sx={{ mb: 4,  borderBottomWidth: '3px', backgroundColor:'#F0E3D5' }} />
      <Grid container spacing={3}>
        {/* Cart Items Section */}
        <Grid item xs={12} md={8}>
          <Box bgcolor="#f9f9f9" borderRadius={1} p={2}>
            <Grid container alignItems="center" p={2} spacing={1} borderBottom="1px solid #ddd">
              <Grid item xs={2} >Product</Grid>
